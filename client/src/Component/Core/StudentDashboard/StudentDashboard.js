            ...
            <main className="px-6 py-2">
                <section className="grid w-full grid-cols-12 gap-5">
                    ...
                    {/* Generating 4 empty cards */}
                    {
                        DashboardData.map((item, index) => (
                            <div key={index}
                                ...
                                className="col-span-3 font-nunito flex flex-col justify-between h-[10rem] rounded-2xl p-4 bg-white text-text_blue-500  shadow-md">
                                <div className="flex justify-between">
                                    <p className="text-[1.7rem] text-[#979797]  ">{item.title}</p>
                                    <img src="" />
                                </div>
                                <p className="text-[1.8rem] text-text_gray-125 font-semibold">{item.count}</p>
                            </div>
                        ))
                    }
                    ...
                    <div className="col-span-6 h-[410px] justify-between flex flex-col font-poppins bg-white text-text_blue-500 px-5 py-3  rounded-xl shadow-md">
                        <p className="text-[1.5rem]  font-semibold h-[100px] border-b-[1px] border-border-100">Student Info</p>
                        <div className="flex justify-between w-full my-1 h-[250px]  mb-5 ">
                            <div className="w-[50%]">

...
import assignmentsubmit from "../../../Assests/Logos/assig_submit.png"; // Replace with correct image path
...
const StudentSubmitAssignment = () => {
    ...
    return (
        <section>
            <Headingtitle title="Submitted Assignment " />
                                ...
                                <div className="flex flex-col  h-full space-y-3 w-full">
                                    <div className="w-full flex justify-between">
                                        <div>
                                            ...
                                            <p className="leading-[17px] text-[#000000] "
                                        ...
                                        <p className="text-white bg-green-500 h-fit  text-[0.75rem] rounded-xl px-2">Accepted</p>

                                    </div>
                                    <p className="text-left font-normal text-[14px] leading-[17.5px] ">
                                        {assignment.dueDate}
                                    </p>
